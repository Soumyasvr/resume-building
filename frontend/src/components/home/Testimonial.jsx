...
const Testimonial = () => {
            ...
            <div className="flex gap-2">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-1">
                        <p>{card.name}</p>
                        <svg className="mt-0.5 fill-green" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <div id="testimonials" className="flex flex-col items-center my-10 scroll-mt-12 mt-28">
        <style>{`
        ...
        <Title title="Don't just take our words" 
            description="Hear what our users to say about  We're always looking for ways to improve. If you have a positive experience with us, leave a review."/>
