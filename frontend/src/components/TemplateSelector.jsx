...
const TemplateSelector = ({selectedTemplate, onChange}) => {
    ...
    const templates = [
        ...
        {id: "minimal", name: "Minimal", preview: "Simple layout focusing on content with ample white space"},
        {id: "minimal-image", name: "Minimal with Image", preview: "Minimal layout with a profile image section"},
    ]
  return (
